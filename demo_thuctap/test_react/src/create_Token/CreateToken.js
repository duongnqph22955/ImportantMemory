...
const CreateToken = () => {
  ...
  const [xAPIkey,setXApiKey] = useState('WZz1huMjD4n_Lrma'); //your x-api-key here
  ...
  const mintNFT = function(e) {
    ...
    axios({
        ...
        data: {
            ...
            // amount: Number(amt)
            // token_address: "7qLVLdm6g57PKyWewpNbMDyK1txuBsRnzYhc4eLEZHHs",
            amount: 100
        },
      })
        // Handle the response from backend here
    ...
    <div>
      <div className="container py-5">
        ...
        {minted && (<div className="text-center pt-4">
          ...
          <button type="button" onClick={mintNFT} class="btn btn-outline-primary">Mint NFT</button>
        </div>)}
