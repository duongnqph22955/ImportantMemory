...
const xKey = "";//enter your x api key here
  ...
  let nftUrl =
    "https://api.shyft.to/sol/v1/nft/read?" + "network=devnet&" + window.location.search.substring(1); //change network to testnet or main net beta if using them
  useEffect(() => {
    fetch(nftUrl, {
      method: "GET",
      headers: {
        ...
        <div className="table-container py-4">
          <table className="table table-striped table-dark">
            <tbody>
              ...
              <tr>
                <td className="p-3">Địa chỉ người tạo</td>
